...
/**
 * {@link Profile#HIGH_PERFORMANCE} kernels for single-precision storage:
 * the same 4x4 register-blocked tiling as {@link TiledDoubleKernels}, with
 * all sixteen accumulators in double. The loaded floats are widened once per
